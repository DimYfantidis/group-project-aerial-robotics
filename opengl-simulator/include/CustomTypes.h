...
float innerProduct3fv(vector3f v, vector3f u)
{
...
real_t innerProduct3fr(vector3r v, vector3r u)
{
    return v[0] * u[0] + v[1] * u[1] + v[2] * u[2];
}

double vectorLength3dv(vector3d v)
{
    return sqrt((v[0] * v[0] + v[1] * v[1] + v[2] * v[2]));
}

double innerProduct3dv(vector3d v, vector3d u)
{
    return v[0] * u[0] + v[1] * u[1] + v[2] * u[2];
}

double vectorDistance2dv(vector2d v, vector2d u)
{
    return sqrt(
        (v[0] - u[0]) * (v[0] - u[0]) + 
        (v[1] - u[1]) * (v[1] - u[1])
